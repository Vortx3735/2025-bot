...
public final class Constants {
  ...
  public static final class Sensors {
    public static final int Beam_Break_Sensors_ID = 0;
    public static final int Gyro_Poter_ID = 1;
    public static final int Acclerometer_port_ID = 2;
  }

  // these are encoder setpoints for elevator
