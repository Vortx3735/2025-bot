...
public class CoralIntake extends SubsystemBase {
  ...
  public CoralIntake(int motor1id, int wrist1id, int motor2id, int wrist2id) {
    ...
    coralInMotor1.configure(coralInMotorConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    coralInMotor2.configure(coralInMotorConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    coralWrist1.configure(coralWristConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    coralWrist2.configure(coralWristConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
  }
